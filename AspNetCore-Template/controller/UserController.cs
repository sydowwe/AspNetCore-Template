...
namespace AspNetCore_Template.controller;
...
public class UserController(IUserService userService) : ControllerBase
{
    ...
    [AllowAnonymous]
    [HttpPost("login")]
    public async Task<IActionResult> LoginUserAsync([FromBody] PasswordLoginRequest loginRequest)
    {
        ...
        [FromBody] TwoFactorAuthLoginRequest twoFactorAuthLoginRequest)
    {
        ...
        if (!result.Succeeded) StatusCode(StatusCodes.Status500InternalServerError, result.ErrorMessage);
